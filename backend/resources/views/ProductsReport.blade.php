...
<body>
                            ...
                            <div class="table-responsive">
                                <table class="table custom-table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <h2><a href="project-view.php">{{ $Order['id'] }}</a></h2>
                                            ...
                                            <td>
                                                <div class="progress progress-xs progress-striped">
                                                    <div class="progress-bar" role="progressbar" data-toggle="tooltip" title="65%" style="width: 
                                                        @if($Order['status'] === 'pending') 70%;
                                                        @elseif($Order['status'] === 'in progress') 70%;
                                                        @elseif($Order['status'] === 'fulfilled') 100%;
                                                        @elseif($Order['status'] === 'rejected') 0%;
                                                        @else auto;
                                                        @endif
                                                        background-color:
                                                        @if($Order['status'] === 'fulfilled') green;
    ...
    <h1 class="center shadow-text">All Products Ordered Report</h1>
    <table class="center table">
        <thead>
            <tr class="table-header">
                <th class="start-th">Product<br><sup>ID</sup></th>
                <th class="data-th">Product<br><sup>Name</sup></th>
                <th class="data-th">Product<br><sup>Price</sup></th>
                <th class="data-th">Ordered<br><sup>Quantity</sup></th>
                <th class="pending-th">Pending<br><sup>Quantity</sup></th>
                <th class="progress-th">inProgress<br><sup>Quantity</sup></th>
                <th class="fulfilled-th">Fulfilled<br><sup>Quantity</sup></th>
                <th class="rejected-th">Rejected<br><sup>Quantity</sup></th>
        ...
        <tbody>
            @foreach ($reports as $report)
                <tr class="table-body">
                    <td class="start-td">{{ $report->product_id }}</td>
                    <td>{{ $report->product_name }}</td>
                    <td>{{ $report->product_price }}</td>
                    <td>{{ $report->ordered_quantity }}</td>
                    <td class="pending-td">{{ $report->pending_quantity }}</td>
                    <td class="progress-td">{{ $report->in_progress_quantity }}</td>
                    <td class="fulfilled-td">{{ $report->fulfilled_quantity }}</td>
                    <td class="rejected-td">{{ $report->rejected_quantity }}</td>
...
.gradient{
	background: repeating-linear-gradient(to bottom right, #3f95ea 0%, #52d3aa 100%);
	background: -moz-linear-gradient(left, #3f95ea 0%, #52d3aa 100%);
	background: -webkit-linear-gradient(left, #3f95ea 0%, #52d3aa 100%);
	background: -ms-linear-gradient(left, #3f95ea 0%, #52d3aa 100%);
	background: linear-gradient(to right, #3f95ea 0%, #52d3aa 100%);
	background: linear-gradient(to right, #3f95ea 0%, #52d3aa 100%);
	box-shadow: 0 1px 1px 0 rgba(0, 0, 0, 0.2);
	height: 60px;
	left: 0;
